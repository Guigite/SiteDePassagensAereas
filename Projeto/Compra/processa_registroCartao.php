...
$result_usuario = "INSERT INTO registroc (Nome, Nascimento, Numero, CPF, CSC, Vencimento, Endereço, CEP) VALUES  ('$nome','$nascimento','$numeroCartao','$cpf','$cvv','$vencimento','$endereco','$cep')";
