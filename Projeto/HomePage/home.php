...
<body>
    ...
    <div class="header">
        ...
        <div class="item2">
            ...
            <a href="../HomePage/ticket.php" class="texto">Ticket</a>
        </div>
    </div>
    <?php
    }else{
...
<body>
    ...
    <div class="header">
        <h1 class="nome"><i class="fa-solid fa-plane-departure"></i>FourFLY</h1>
        <div class="item2">
            <a href="../Login_ADM/login_adm.php"  class="texto">Funcionários</a>
            <a href="../Login_Cliente/login_cliente.php"  class="texto">Fazer Login</a>
        </div>
    </div>
